...
class Player(GameSprite):
    ...
    def fire(self):
        bullet = Bullet('ammp.png', self.rect.right , self.rect.centery , 15, 20 ,15)
        bullets.add(bullet)
...
packman = Player('hero.png', 5 , win_height - 80,100 ,80,0,0)
